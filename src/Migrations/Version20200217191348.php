 ...
 */
final class Version20200217191348 extends AbstractMigration
{
    ...
    /*    $this->addSql('CREATE TABLE souvenir (id INT AUTO_INCREMENT NOT NULL, booking_id INT NOT NULL, anecdote LONGTEXT DEFAULT NULL, resume VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_53FBDDEE3301C60 (booking_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
